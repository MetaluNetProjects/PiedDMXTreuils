...
#define MAXSPEED ((unsigned long)(1UL<<24))
	...
	if(dcmotorVars.PWMFinal < dcmotorVars.PWMConsign) {
		dcmotorVars.PWMFinal += 25;
		if(dcmotorVars.PWMFinal > dcmotorVars.PWMConsign) dcmotorVars.PWMFinal = dcmotorVars.PWMConsign;
	} else if(dcmotorVars.PWMFinal > dcmotorVars.PWMConsign) {
		dcmotorVars.PWMFinal -= 25;
		if(dcmotorVars.PWMFinal < dcmotorVars.PWMConsign) dcmotorVars.PWMFinal = dcmotorVars.PWMConsign;
	}
